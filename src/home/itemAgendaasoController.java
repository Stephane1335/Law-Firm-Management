...
public class itemAgendaasoController implements Initializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(itemAgendaasoController.class);
    ...
    public void handleDos(ActionEvent actionEvent) throws IOException{
        if (actionEvent.getSource() == btnDetailDos) {
            Parent root6 = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("detailagendaaso.fxml")));
