...
public class AjoutClientasoController implements Initializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(AjoutClientasoController.class);
    ...
    public void ajoutclient(ActionEvent event) throws SQLException, IOException {
        ...
        String query = "INSERT INTO `client`(`nomClient`, `contact`, `profession`, `adresse`) VALUES (?,?,?,?)";
        PreparedStatement preparedStatement = connection.prepareStatement(query);
        preparedStatement.setString(1, nomClientText);
        preparedStatement.setString(2,contactText);
        preparedStatement.setString(3, professionText);
        preparedStatement.setString(4, adresseText);
