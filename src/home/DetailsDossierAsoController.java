...
public class DetailsDossierAsoController implements Initializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(DetailsDossierAsoController.class);
    ...
    public void delete(ActionEvent event) throws Exception{
        ...
        Preferences userPreference = Preferences.userRoot();
        String info = userPreference.get("id", String.valueOf(i));
        String query = "DELETE FROM `dossier` WHERE `id_Dossier`  ="+info;
        PreparedStatement preparedStatement = cnx.prepareStatement(query);
