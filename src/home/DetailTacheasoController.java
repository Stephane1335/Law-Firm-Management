...
public class DetailTacheasoController implements Initializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(DetailTacheasoController.class);
