...
public class AgendaCollabo {
    private static final Logger LOGGER = LoggerFactory.getLogger(AgendaCollabo.class);
    ...
    public AgendaCollabo(int id_rdv, Date daterdv, String heurerdv, String lieurdv, String objetrdv, String clientrdv, String dossierrdv) {
        this.id_rdv = id_rdv;
