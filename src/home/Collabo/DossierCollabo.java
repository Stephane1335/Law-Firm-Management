...
public class DossierCollabo {
    private static final Logger LOGGER = LoggerFactory.getLogger(DossierCollabo.class);
    ...
    public DossierCollabo(int id_dossier, String nomAvocat, String nomDossier, String nomClient, Date date_dossier) {
