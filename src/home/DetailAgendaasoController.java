...
public class DetailAgendaasoController implements Initializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(DetailAgendaasoController.class);
